...
impl TracingLayer {
    ...
    pub fn with_capacity(base_path: &str, capacity: usize) -> Self {
        ...
        let env_filter = EnvFilter::try_from_default_env()
            .unwrap_or_else(|_| EnvFilter::new("trace,tracing_subscriber_axum=off,log=off"));
        ...
        // Create shared state
        let control_state = Arc::new(ControlState::new(storage.clone()));
        ...
        let api_router = crate::api::create_api_router(control_state);
...
mod tests {
    ...
    fn test_tracing_layer_creation() {
        ...
        // Basic test to ensure it can be created
        assert!(true);
    }
